(function (global, factory) {
    ...
    var getAddress = function getAddress(_ref) {
      ...
      var deliveryAddress = _ref.deliveryAddress;
    ...
    var useDeliveryOptions = function useDeliveryOptions(onChange) {
      ...
      var result = React.useMemo(function () {
        ...
        r.address = getAddress((context == null ? void 0 : context.data) || {});
        ...
        return r;
      }, [context, deliveryDate, deliveryMethods, deliveryTypes, selectedMethod, selectedType]);
      React.useEffect(function () {
        getDeliveryMethod();
        getDeliveryType();
    ...
    var DeliveryOptions = function DeliveryOptions(_ref) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(vanguard.Box, {
        ...
        bold: true
      }, t('vanguard.checkout.delivery.recipient.subtitle') || 'Send to:')), /*#__PURE__*/React__default['default'].createElement(Address, address, /*#__PURE__*/React__default['default'].createElement(Address.Action, null, t('vanguard.checkout.address.cta.change') || 'Change')))));
    };

    var usePayment = function usePayment() {
      var _billingAddress$data, _billingAddress$data$, _billingAddress$data2;
      ...
      return {
        ...
        billingAddress: ((_billingAddress$data = billingAddress.data) == null ? void 0 : (_billingAddress$data$ = _billingAddress$data.addresses) == null ? void 0 : _billingAddress$data$.length) > 0 ? billingAddress.data.addresses[0] : [],
        defaultPaymentTerm: (_billingAddress$data2 = billingAddress.data) == null ? void 0 : _billingAddress$data2.defaultPaymentTerm,
        isLoading: billingAddress.isLoading
      };
    };

    var Payment = function Payment() {
      var _defaultPaymentTerm$d, _billingAddress$count;

      var _usePayment = usePayment(),
          billingAddress = _usePayment.billingAddress,
          defaultPaymentTerm = _usePayment.defaultPaymentTerm,
          isLoading = _usePayment.isLoading;
      ...
      return /*#__PURE__*/React__default['default'].createElement(vanguard.Box, {
        ...
        bold: true,
        color: "gray-500"
      }, t('vanguard.checkout.payment.tile')), /*#__PURE__*/React__default['default'].createElement(vanguard.Box, {
        paddingX: "md",
        className: "flex justify-around"
      }, /*#__PURE__*/React__default['default'].createElement(vanguard.Box, null, /*#__PURE__*/React__default['default'].createElement(vanguard.Typography, {
        bold: true,
        color: "gray-900"
      }, t('vanguard.checkout.payment.method')), /*#__PURE__*/React__default['default'].createElement(vanguard.Box, {
        className: "flex space-x-8"
      }, /*#__PURE__*/React__default['default'].createElement(vanguard.Radio, {
        label: t('vanguard.checkout.payment.method.invoice'),
        testid: "vanguard.checkout.payment.method.invoice",
        size: "sm",
        variant: "gray",
        checked: true
      }), /*#__PURE__*/React__default['default'].createElement(vanguard.Radio, {
        label: t('vanguard.checkout.payment.method.card'),
        ...
        bold: true,
        color: "tertiary"
      }, t('vanguard.checkout.payment.termsOfPayment')), /*#__PURE__*/React__default['default'].createElement(vanguard.Typography, {
        color: "green-600"
      }, (_defaultPaymentTerm$d = defaultPaymentTerm == null ? void 0 : defaultPaymentTerm.description) != null ? _defaultPaymentTerm$d : '-'))), /*#__PURE__*/React__default['default'].createElement(vanguard.Box, null, /*#__PURE__*/React__default['default'].createElement(vanguard.Typography, {
        bold: true,
        color: "gray-900"
      }, t('vanguard.checkout.payment.billing')), !isLoading && /*#__PURE__*/React__default['default'].createElement(Address, {
        company: 'Intive',
        address: (billingAddress == null ? void 0 : billingAddress.line1) + " " + (billingAddress == null ? void 0 : billingAddress.line2),
        region: (billingAddress == null ? void 0 : billingAddress.postalCode) + " " + (billingAddress == null ? void 0 : billingAddress.town),
        country: billingAddress == null ? void 0 : (_billingAddress$count = billingAddress.country) == null ? void 0 : _billingAddress$count.name
      }), /*#__PURE__*/React__default['default'].createElement(vanguard.Button, {
        testid: "vanguard.checkout.address.cta.change",
        disabled: true,
        isLink: true
      }, t('vanguard.checkout.address.cta.change')))));
    };
    ...
    var useCheckout = function useCheckout() {
      ...
      var _useResource = useResource(getCheckoutDataUri, {
        cartId: cartCode
          ...
          checkoutDataResponses = _useResource.responses;

      React.useEffect(function () {
        getCheckoutData();
      }, [getCheckoutData]);
      return checkoutDataResponses.get;
    };
